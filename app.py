...
# ... (continua o restante do código como estava antes)
...
df_horas = df_mes_corrente.sort_values(by=["Rentabilidade (%)", "Margem (€)"], ascending=False)[[
...
# Aplicar estilo para destacar linhas com horas sugeridas

# Aplicar estilo para destacar linhas com horas sugeridas > 0
