...
# 📥 Upload
uploaded_file = st.file_uploader("📤 Envie o arquivo rentabilidade.xlsx", type="xlsx")
...
col1.metric("💰 Proveitos", f"€ {total_proveitos:,.2f}".replace(",", "X").replace(".", ",").replace("X", "."))
col2.metric("💸 Custos", f"€ {total_custos:,.2f}".replace(",", "X").replace(".", ",").replace("X", "."))
col3.metric("📐 Margem", f"€ {margem_total:,.2f}".replace(",", "X").replace(".", ",").replace("X", "."))
col4.metric("📊 Rentabilidade", f"{rentabilidade_total:.2f}%")
